      ...
      <div className='Versions_container'> 
        ...
        <Row>
          ...
          <Col xs={12} sm={12} md={6}>
            ...
            <path d="M13.6666 42C13.6666 42 22.1666 22.1667 42 22.1667C61.8333 22.1667 70.3333 42 70.3333 42C70.3333 42 61.8333 61.8334 42 61.8334C22.1666 61.8334 13.6666 42 13.6666 42Z" stroke="#A3A073" strokeWidth="3.66667" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M41.5 51C46.1944 51 50 46.7467 50 41.5C50 36.2533 46.1944 32 41.5 32C36.8056 32 33 36.2533 33 41.5C33 46.7467 36.8056 51 41.5 51Z" stroke="#A3A073" strokeWidth="3.66667" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            ...
            <Col xs={12} sm={12} md={6}>
              <div className='Version_items'>
                <div className='icon'>
                  ...
                  <svg width="84" height="84" viewBox="0 0 84 84" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect width="84" height="84" rx="8" fill="#A3A073" fillOpacity="0.22"/>
                  <path d="M16.5 16.5V67.5H67.5" stroke="#A3A073" strokeWidth="3.66667" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M61.8333 33.5L47.6666 47.6667L36.3333 36.3333L27.8333 44.8333" stroke="#A3A073" strokeWidth="3.66667" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
